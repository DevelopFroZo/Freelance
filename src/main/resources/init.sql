...
-- Add users
-- 1
insert into users( name, login, password, registeredAt, description, balance, role ) values ( 'FroZo', 'FroZo', '123456', '2020-05-22', 'Description of user', 5000, 'ROLE_USER' );
-- 2
...
insert into executor_ratings_values( ExecutorRating_id, rating, number ) values ( 1, 5, 0 ), ( 1, 5, 1 ), ( 1, 5, 2 );
insert into executor_ratings_values( ExecutorRating_id, rating, number ) values ( 2, 4, 0 ), ( 2, 3, 1 ), ( 2, 2, 2 );
insert into executor_ratings_values( ExecutorRating_id, rating, number ) values ( 3, 4, 0 ), ( 3, 4, 1 ), ( 3, 5, 2 );

-- 4, 5
insert into executor_ratings( user_id, category_id ) values ( 2, 3 ), ( 2, 5 );
insert into executor_ratings_values( ExecutorRating_id, rating, number ) values ( 4, 4, 0 ), ( 4, 3, 1 );
insert into executor_ratings_values( ExecutorRating_id, rating, number ) values ( 5, 4, 0 ), ( 5, 5, 1 );

-- 6, 7, 8
insert into executor_ratings( user_id, category_id ) values ( 5, 2 ), ( 5, 5 ), ( 5, 6 );
insert into executor_ratings_values( ExecutorRating_id, rating, number ) values ( 6, 3, 0 ), ( 6, 4, 1 ), ( 6, 4, 2 );
insert into executor_ratings_values( ExecutorRating_id, rating, number ) values ( 7, 4, 0 ), ( 7, 5, 1 ), ( 7, 4, 2 );
insert into executor_ratings_values( ExecutorRating_id, rating, number ) values ( 8, 2, 0 ), ( 8, 3, 1 ), ( 8, 3, 2 );
...
-- Add solutions
insert into solutions( description, executor_id, task_id ) values ( 'A description for solution', 5, 1 );
